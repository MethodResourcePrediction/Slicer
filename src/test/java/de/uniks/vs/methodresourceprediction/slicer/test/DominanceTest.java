...
public class DominanceTest {
	...
	@Test
	public void cfg1() throws IOException, InvalidClassFileException, InterruptedException, ExportException {
...
//		System.out.println(javaSourceFromGraph(controlDependency));
		...
		// Test Dominance
		Graph<Integer, DefaultEdge> expectedDominance = new DefaultDirectedGraph<Integer, DefaultEdge>(
				DefaultEdge.class);
		...
		// Test PostDominance
		Graph<Integer, DefaultEdge> expectedPostDominance = new DefaultDirectedGraph<Integer, DefaultEdge>(
				DefaultEdge.class);
		...
		Graph<Integer, DefaultEdge> expectedStrictDominance = new DefaultDirectedGraph<Integer, DefaultEdge>(
				DefaultEdge.class);
		...
		Graph<Integer, DefaultEdge> expectedStrictPostDominance = new DefaultDirectedGraph<Integer, DefaultEdge>(
				DefaultEdge.class);
		...
		Graph<Integer, DefaultEdge> expectedImmediateDominance = new DefaultDirectedGraph<Integer, DefaultEdge>(
				DefaultEdge.class);
		...
		Graph<Integer, DefaultEdge> expectedImmediatePostDominance = new DefaultDirectedGraph<Integer, DefaultEdge>(
				DefaultEdge.class);
		...
		Graph<Integer, DefaultEdge> expectedControlDependency = new DefaultDirectedGraph<Integer, DefaultEdge>(
				DefaultEdge.class);
	...
	@Test
	public void cfg2() throws IOException, InvalidClassFileException, InterruptedException, ExportException {
		// Extended 1:
		// https://www.cs.colorado.edu/~kena/classes/5828/s00/lectures/lecture15.pdf
		AbstractGraph<Integer, DefaultEdge> cfg = new DefaultDirectedGraph<Integer, DefaultEdge>(DefaultEdge.class);
...
//		System.out.println(javaSourceFromGraph(controlDependency));
	...
	@Test
	public void cfg3() throws IOException, InvalidClassFileException, InterruptedException, ExportException {
		// Extended 2:
		// https://www.cs.colorado.edu/~kena/classes/5828/s00/lectures/lecture15.pdf
		AbstractGraph<Integer, DefaultEdge> cfg = new DefaultDirectedGraph<Integer, DefaultEdge>(DefaultEdge.class);
...
//		System.out.println(javaSourceFromGraph(controlDependency));
	...
	@Test
	public void cfg4() throws IOException, InvalidClassFileException, InterruptedException, ExportException {
...
//		System.out.println(javaSourceFromGraph(controlDependency));
	...
	private static void plot(Graph<Integer, DefaultEdge> graph) throws IOException, InterruptedException {
	...
	private static String javaSourceFromGraph(SlicerGraph<Integer> slicerGraph)
		...
		if (slicerGraph instanceof ControlDependency) {
			writer.append(String.format("%s.addVertex(ControlDependency.ROOT_INDEX);\n", expectedObjectVarName));
		}
		...
		writer.append(String.format("IntStream.rangeClosed(%s, %s).forEach(i -> %s.addVertex(i));\n", min, max,
				expectedObjectVarName));

		for (DefaultEdge edge : graph.edgeSet()) {
			final Integer edgeSource = graph.getEdgeSource(edge);
			final Integer edgeTarget = graph.getEdgeTarget(edge);
			writer.append(String.format("%s.addEdge(%s, %s);\n", expectedObjectVarName, edgeSource, edgeTarget));
		}
		writer.append(String.format("compareGraphs(%s.getGraph(), %s);\n", objectVarName, expectedObjectVarName));

		return writer.toString();
	}

	private static void compareGraphs(Graph<Integer, DefaultEdge> graph1, Graph<Integer, DefaultEdge> graph2) {
