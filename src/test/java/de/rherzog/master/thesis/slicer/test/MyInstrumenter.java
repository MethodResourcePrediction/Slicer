...
//		
//		ControlFlow controlFlow = new ControlFlow("../EvaluationPrograms.jar", "LSleep;.f([Ljava/lang/String;)V");
//		
//		instrumenter.instrument(, Arrays.asList(0), Arrays.asList(0), Collections.emptyMap(),
//				Collections.emptySet());
//		instrumenter.finalize();

		String argString = "--inputJar ../EvaluationPrograms.jar --methodSignature \"LSleep;.f([Ljava/lang/String;)V\" --mainClass \"Sleep\" --instructionIndexes 8 --outputJar generated/2_50/sliced.jar";
